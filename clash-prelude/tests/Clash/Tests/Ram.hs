...
initMem, undefEn, undefWAddr, undefWData, enFalse, oobWAddr, oobRAddr
  :: Samples
...
oobWAddr = initMem <>         [ ( 0, False    , 255      , 2        , Just 0 )
                              , ( 0, False    , 0        , 3        , Just 0 )
                              , ( 1, False    , 0        , 3        , Just 1 )
                              ]

oobRAddr = initMem <>         [ ( 1, False    , 0        , 3        , Just 1 )
                              , ( 2, False    , 0        , 3        , Just 4 )
                              , ( 0, False    , 0        , 3        , Just 0 )
                              ]
...
tests = testGroup "Ram"
  ...
  , testCase "Deasserted enable, OOB address" $ ramAssertion ram oobWAddr
  , testCase "Read address strictness" $ ramAssertion maskOobRead oobRAddr
  ]
